...
const mockEvents: Event[] = [
  {
    ...
    category: 'Music',
    isFeatured: true,
    venue: { name: 'Greenfield Valley Amphitheater', address: '123 Music Lane, Greenfield, CA' },
    schedule: [
      { time: '18:00', activity: 'Gates Open' },
      { time: '19:00', activity: 'Opening Act: The Voids' },
      { time: '21:00', activity: 'Headliner: Galaxy Drifters' },
    ],
    speakers: [],
  ...
  },
  {
    ...
    category: 'Technology',
    isTrending: true,
    venue: { name: 'Metropolis Convention Center', address: '456 Tech Ave, Metropolis' },
    schedule: [
      { time: '09:00', activity: 'Registration & Coffee' },
      { time: '10:00', activity: 'Keynote by Dr. Evelyn Reed' },
      { time: '12:00', activity: 'Lunch Break' },
      { time: '14:00', activity: 'Workshop: Applied Machine Learning' },
    ],
  ...
  },
  {
    ...
    category: 'Food',
    venue: { name: 'Harborfront Park', address: '789 Waterfront Rd, Bayside' },
  ...
  },
  {
    ...
    category: 'Sports',
    venue: { name: 'Downtown Plaza', address: '1 Main Street, Downtown' },
  ...
  },
  {
    ...
    isTrending: true,
    isFeatured: true,
    venue: { name: 'The Grand Gallery', address: '101 Gallery Row, Art District' },
  ...
  },
  {
    ...
    category: 'Conference',
    isFeatured: true,
    venue: { name: 'Apex Conference Hall', address: '202 Summit Peak, Business Bay' },
